...
public class CopyRight extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea2.setText(
                "Η εικόνα του Λαβυρίνθου στην αρχική οθόνη είναι απο την σελίδα pexels.com\nΟι εικόνες του παίκτη, το γρασίδι , ο τείχος , οι πόρτες και η σημαια δημιουργήθηκαν απο το piskelapp.com");
        jScrollPane2.setViewportView(jTextArea2);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Πνευματικά Δικαιώματα ");
